...
# 路径，可改(注意大小写！)
RAW_DIR = Path(r"D:\phd\BatteryTwin-Benchmark-DataPrep\data\raw\XJTU_dataset\XJTU battery dataset\Batch-4")
PROCESSED_DIR = Path(r"D:\phd\BatteryTwin-Benchmark-DataPrep\data\processed\dataset_09\Batch-4")
...
def generate_summary():
    ...
    df.to_csv(PROCESSED_DIR / "dataset_XJTU_Batch-4_cycle_summary.csv", index=False, encoding='utf-8-sig')
